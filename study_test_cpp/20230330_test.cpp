...
// 2. 캐릭터 클래스
//      - 필드    
//      hp:100, level:1, 기본공격력:10, 치명타확률:5%, 치명타 데미지:100%, 보유무기(노말, 레어, 유니크)
//      - 메소드(기능)
//      상태창 : 플레이어 정보를 출력
//      장비착용 : 
//      사냥하기 : 몬스터 체력100을 소환하여 플레이어가 공격하여 몬스터의 체력이 0이하가 되면
//              레벨업이 되고 체력이 10 증가 및 기본 공격 5증가. 그리고 무기를 확률적으로 드랍함.
//      월드보스잡기 : 총 10번의 공격을 하며 공격데미지를 합산. 
//      종료 : 게임을 종료
// 3. 무기 클래스
//      - 필드
//      등급(노말, 레어, 유니크), 무기공격력, 치명타 확률, 치명타 데미지
//      - 메소드(기능)
//      무기 등급, 공격력, 치명타 확률, 치명타 데미지 을 받는 생성자.
// 4. 등급 클래스(무기에 상속) - 노말, 레어, 유니크 생성.
//      - 필드
